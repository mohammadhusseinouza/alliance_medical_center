...
const arrowButtonClass =
  "absolute top-[44%] z-[5] flex h-[58px] w-[48px] -translate-y-1/2 items-center justify-center bg-white/90 text-hero-arrow shadow-hero-arrow transition-colors duration-200 hover:bg-hero-arrow-hover hover:text-white mw-900:h-[50px] mw-900:w-[40px]";
        ...
        <div className="pointer-events-none relative z-[2] mx-auto flex h-full max-w-[1400px] items-center px-[70px] mw-1300:px-[45px] mw-900:items-end mw-900:px-[22px] mw-900:pb-[40px]">
          <div className="pointer-events-auto flex w-[min(620px,48%)] flex-col pb-[90px] pt-[30px] mw-900:w-full mw-900:pb-0 mw-900:pt-0">
            <h1
              ...
              className="mt-0 max-w-[620px] animate-[hero-up_0.6s_ease_0.12s_both] font-heading text-[clamp(40px,4.2vw,60px)] font-bold leading-[1.04] tracking-[-1.3px] text-hero-heading motion-reduce:animate-none mw-1300:text-[48px] mw-900:text-[38px]"
            >
            ...
            <p
              ...
              className="mt-5 max-w-[480px] animate-[hero-up_0.6s_ease_0.19s_both] text-[16px] leading-[1.65] text-hero-body motion-reduce:animate-none"
            >
            ...
            >
              <Link
                ...
                className="inline-flex min-h-[50px] items-center gap-[9px] rounded-[7px] px-[22px] text-[14px] font-semibold text-white shadow-bright-cta [transition:background_220ms_ease,transform_220ms_ease,box-shadow_220ms_ease] hover:-translate-y-0.5 hover:shadow-bright-cta-hover"
