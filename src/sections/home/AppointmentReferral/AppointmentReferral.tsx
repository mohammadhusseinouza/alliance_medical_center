...
export function AppointmentReferral() {
  ...
  return (
    <section className="relative bg-appointment-referral-section-bg px-0 pb-[55px] pt-[100px] mw-700:px-[15px] mw-700:pb-10 mw-700:pt-[30px]">
      <div
      ...
      >
        ...
        <div className="ml-[470px] pb-[65px] pl-[60px] pr-[90px] pt-[82px] mw-1100:ml-[370px] mw-700:ml-0 mw-700:px-[25px] mw-700:pb-10 mw-700:pt-[45px]">
          ...
          <h2 className="mt-[18px] font-heading text-[48px] font-normal leading-[1.1] text-white mw-1100:text-[40px]">
