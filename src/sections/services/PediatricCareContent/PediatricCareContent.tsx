  ...
  return (
    <div className="min-w-0">
      <div className="aspect-[16/8] w-full overflow-hidden rounded-2xl">
        <ImagePlaceholder label={t("pediatricCare.mainPhotoAlt")} className="h-full w-full" />
      </div>
      ...
      <div className="mt-5 grid grid-cols-2 gap-[22px] mw-880:grid-cols-1">
        <div className="aspect-[4/3] w-full overflow-hidden rounded-[14px]">
          <ImagePlaceholder label={t("pediatricCare.pairAlt.examination")} className="h-full w-full" />
        </div>
        <div className="aspect-[4/3] w-full overflow-hidden rounded-[14px]">
          <ImagePlaceholder label={t("pediatricCare.pairAlt.wellness")} className="h-full w-full" />
        </div>
      </div>
