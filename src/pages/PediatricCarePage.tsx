...
import ctaPortraitImage from "../assets/pediatric-care/Pediatric healthcare provider ready to help patients.png";
import heroImage from "../assets/pediatric-care/fh-hero.png";
    ...
    <>
      ...
      <main>
        <div className="md:hidden">
          <MobileServiceDetail slug="pediatric-care" />
        </div>
